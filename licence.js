// licence.js: ARLing licence verification for camt.053 do Excelu Pro.
//
// Plan "sepa-pro" is the shared bundle plan sold on the bundle page
// https://arling.sk/bankove-nastroje/, which also unlocks Pro in SEPA
// pain.001 Doctor, SEPA pain.001 Generátor, and Párovač platieb. There is
// no camt.053-only plan: Pro here is always activated via the bundle
// (bought here, on the bundle page, or on any of the other three tools;
// every ARLing tool shares the arling.sk origin, hence localStorage).
//
